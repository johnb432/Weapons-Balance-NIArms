...
class HLC_rifle_XM8_MWSF_Carbine_Fish: HLC_Rifle_XM8_MWSF_Carbine {
    displayName = "XM8 MWSF (Carbine/Bass)";
};
...
class HLC_Rifle_XM8_Proto_Carbine: HLC_rifle_XM8_Carbine {
    displayName = "XM8 Prototype (Carbine)";
    mass = 64;
    class WeaponSlotsInfo: WeaponSlotsInfo {
        mass = 64;
    };
...
class hlc_rifle_XM8_Proto_DMAR_OD: hlc_rifle_XM8_Proto_DMAR {
    displayName = "XM8 Prototype (DMAR/OD)";
};
class hlc_rifle_XM8_Proto_DMAR_Tan: hlc_rifle_XM8_Proto_DMAR {
    displayName = "XM8 Prototype (DMAR/Tan)";
};
